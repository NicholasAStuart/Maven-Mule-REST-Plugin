...
public class Deploy extends AbstractMojo {
    ...
    /**
     * The name that the application will be deployed as. Default is "MuleApplication"
     * 
    ...
    /**
     * The version that the application will be deployed as. Default is the current time in milliseconds.
     * 
    ...
    private void restfullySendToMuleMmc(File packageFile) throws ClientProtocolException, IOException {
